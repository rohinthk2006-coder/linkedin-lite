-- =============================================================================
-- LinkSphere - MySQL 8.0+ Seed Data Migration (V2__seed_data.sql)
-- Dialect: MySQL 8.0+
-- Duplicate handling: INSERT IGNORE INTO / ON DUPLICATE KEY UPDATE
...
-- -----------------------------------------------------------------------------
-- 2. Seed Users
-- BCrypt password hash below is for 'password123':
-- $2a$10$GRLdNijSQMUvl/au9ofL.eDwmoohzzS7.rmNSJZ.0FxGQrvkWGyWm
-- -----------------------------------------------------------------------------
